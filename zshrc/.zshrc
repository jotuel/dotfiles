...
alias test=""
alias norminette+="python3 ~/Documents/SourceFiles/norminette+/run.py"
alias 42FileChecker='bash ~/42FileChecker/42FileChecker.sh'

#EMAIL, BROWSER enviroment variable && python modules in PATH
export MAIL=jtuomi@student.hive.fi
